...
class About extends Component {
  render() {
    return (
      <div>
        <h6>About Yoonie Yael</h6>
        <h1>A warrior of only light, from within I see the ALL.  My passion is soul mission to be an inspirational guiding light.</h1>
        
        <p>Peace, love, and blessings well-beings! I am a warrior of only light, from with I see the ALL, my spiritual journey started the Island of Jamaica.
